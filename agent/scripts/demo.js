...
// These are the well-known, publicly documented Anvil default keys (accounts
// #0-#3). They only ever control worthless local-chain funds. Override via env
// for any non-default local setup. NEVER point this script at a real network.
const KEYS = {
  farmer:
    process.env.DEMO_FARMER_KEY ||
    "0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80",
  oracle:
    process.env.DEMO_ORACLE_KEY ||
    "0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d",
  buyer:
    process.env.DEMO_BUYER_KEY ||
    "0x5de4111afa1a4b94908f83103eb1f1706367c2e68ca870fc3fb9a804cdab365a",
  outsider:
    process.env.DEMO_OUTSIDER_KEY ||
